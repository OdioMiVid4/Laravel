...
<body>
  <header>
    ...
    <nav>
      <ul id="menu">
        ...
        <li><a href="/ubicacion" style="color:#00ffaa;">Ubicación</a></li>
  ...
  <main>
    ...
    <p class="ubicacion-info">
      Encuéntranos fácilmente. Estamos ubicados en el corazón de la ciudad, en un punto estratégico de fácil acceso.
